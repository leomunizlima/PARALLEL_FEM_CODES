...
int ebemvNDOF4(ParametersType *Parameters, MatrixDataType *MatrixData, FemStructsType *FemStructs, double *P, double *Q)
{
	...
	MPI_VectorUpdate(RANK,NPROC, Parameters, FemStructs, &P[neq_bef]);
