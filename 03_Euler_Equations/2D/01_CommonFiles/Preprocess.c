		...
		FemFunctionsType **FemFunctions_out, FemOtherFunctionsType **FemOtherFunctions_out)
{
	...
	if (narg!=2)
	{
		if (RANK==0) printf("Use ./EulerEquations2D <Parameters file according to README>\n");
		MPI_Finalize();
	}
	if (NPROC<2){
	...
	if (RANK == 0){
		...
		for (I=1; I<NPROC;I++){
			...
			MPI_Send(&(Parameters->TimeIntegrationTolerance), 	1, MPI_DOUBLE, I, 0, MPI_COMM_WORLD);
			MPI_Send(&(Parameters->StabilizationTolerance), 	1, MPI_DOUBLE, I, 0, MPI_COMM_WORLD);
			...
			MPI_Send(Parameters->TimeIntegration, 			200, MPI_CHAR, I, 0, MPI_COMM_WORLD);
			MPI_Send(Parameters->StopAtSteadyState,			200, MPI_CHAR, I, 0, MPI_COMM_WORLD);
			MPI_Send(&(Parameters->Alpha),			 	1, MPI_DOUBLE, I, 0, MPI_COMM_WORLD);
			MPI_Send(&(Parameters->DeltaT),			 	1, MPI_DOUBLE, I, 0, MPI_COMM_WORLD);
			MPI_Send(&(Parameters->FinalTime),		 	1, MPI_DOUBLE, I, 0, MPI_COMM_WORLD);
			MPI_Send(Parameters->Dimensionless, 			200, MPI_CHAR, I, 0, MPI_COMM_WORLD);
			MPI_Send(&(Parameters->Mach),			 	1, MPI_DOUBLE, I, 0, MPI_COMM_WORLD);
			MPI_Send(&(Parameters->NonLinearMaxIter), 		1,    MPI_INT, I, 0, MPI_COMM_WORLD);
			MPI_Send(Parameters->StopMulticorrection, 		200, MPI_CHAR, I, 0, MPI_COMM_WORLD);
			...
			MPI_Send(&(Parameters->invY[0]),		 	1, MPI_DOUBLE, I, 0, MPI_COMM_WORLD);
			MPI_Send(&(Parameters->invY[1]),		 	1, MPI_DOUBLE, I, 0, MPI_COMM_WORLD);
			MPI_Send(&(Parameters->invY[2]),		 	1, MPI_DOUBLE, I, 0, MPI_COMM_WORLD);
			MPI_Send(&(Parameters->invY[3]),		 	1, MPI_DOUBLE, I, 0, MPI_COMM_WORLD);
		...
		MPI_Recv(&(Parameters->TimeIntegrationTolerance), 	1, MPI_DOUBLE, 0, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
		MPI_Recv(&(Parameters->StabilizationTolerance), 	1, MPI_DOUBLE, 0, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
		...
		MPI_Recv(Parameters->TimeIntegration, 			200, MPI_CHAR, 0, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
		MPI_Recv(Parameters->StopAtSteadyState,			200, MPI_CHAR, 0, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
		MPI_Recv(&(Parameters->Alpha),			 	1, MPI_DOUBLE, 0, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
		MPI_Recv(&(Parameters->DeltaT),			 	1, MPI_DOUBLE, 0, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
		MPI_Recv(&(Parameters->FinalTime),		 	1, MPI_DOUBLE, 0, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
		MPI_Recv(Parameters->Dimensionless, 			200, MPI_CHAR, 0, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
		MPI_Recv(&(Parameters->Mach),			 	1, MPI_DOUBLE, 0, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
		MPI_Recv(&(Parameters->NonLinearMaxIter), 		1,    MPI_INT, 0, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
		MPI_Recv(Parameters->StopMulticorrection, 		200, MPI_CHAR, 0, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
		...
		MPI_Recv(&(Parameters->invY[0]),		 	1, MPI_DOUBLE, 0, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
		MPI_Recv(&(Parameters->invY[1]),		 	1, MPI_DOUBLE, 0, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
		MPI_Recv(&(Parameters->invY[2]),		 	1, MPI_DOUBLE, 0, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
		MPI_Recv(&(Parameters->invY[3]),		 	1, MPI_DOUBLE, 0, 0, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
	...
	for (I=0, neq = 0, neqrho=0 , nsend_bef = 0, nsend_aft = 0, nrecv_bef = 0, nrecv_aft = 0; I<nnodes; I++)
	{
	...
	J = 0;
	for (I = 0; I < nnodes; I++){
		if(Node[I].Type[0] != 0){ // a densidade é incógnita naquele nó
			eqrho[J] = Node[I].invP_id[0];
			J++;
		}
	}
	...
	//	Permutation_of_LM(Parameters, MatrixData, FemStructs);
