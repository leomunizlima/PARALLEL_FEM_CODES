...
double CAU_DD_ShockCapture(double *Re_old, double *delta_old, int e, double kx, double ky, double Be_x, double Be_y, 
			   double gamma, double ue1, double ue2, double ue3, double ueb, double feb, double y23, double y31, double y12, 
