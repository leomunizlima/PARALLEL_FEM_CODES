...
void MPI_VectorUpdate(int RANK, int NPROC, ParametersType *Parameters, FemStructsType *FemStructs, double *P, int tag)
{
	...
	double *SBuff_bef = FemStructs->SendBuffer_bef; 
	double *SBuff_aft = FemStructs->SendBuffer_aft;
	double *RBuff_bef = FemStructs->RecvBuffer_bef;
	double *RBuff_aft = FemStructs->RecvBuffer_aft;
