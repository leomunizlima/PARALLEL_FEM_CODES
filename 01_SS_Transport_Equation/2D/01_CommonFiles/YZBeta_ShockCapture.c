...
double YZBeta_ShockCapture(double *Re_old, double *delta_old, int e, double kx, double ky, double Be_x, double Be_y, double gamma, 
				double ue1, double ue2, double ue3, double ueb, double feb, double y23, double y31, double y12, 
				double x32, double x13, double x21, double invArea, double h)
{
	...
	if (fabs(normRu-Re_old[e])/normRu < 0.2)
		w = 0.;
	Eu = w*Eu + (1.0-w)*delta_old[e];
	Re_old[e] = normRu;
	delta_old[e] = Eu;
