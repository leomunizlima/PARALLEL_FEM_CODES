...
int main(int argc, char **argv)
{
	...
	/********************************************************* Process *********************************************************/
	clock_gettime(CLOCK_REALTIME, &Start);
	Process(RANK, NPROC, Parameters, MatrixData, FemStructs, FemFunctions, FemOtherFunctions);
	clock_gettime(CLOCK_REALTIME, &End);
	...
	/******************************************************** Postprocess *******************************************************/
	clock_gettime(CLOCK_REALTIME, &Start);
	Postprocess(RANK, NPROC, Parameters, MatrixData, FemStructs, FemFunctions, FemOtherFunctions);
	clock_gettime(CLOCK_REALTIME, &End);
